...
DOC_TYPE_CONTEXT: dict[str, str] = {
    ...
    "entretien": (
        ...
        "conventionnelle — vérifier la cohérence typographique, ne pas signaler le format lui-même.\n"
        "4. Les noms propres cités par l'interviewé (personnes, lieux, œuvres, entreprises, dates, chiffres) "
        "sont des données factuelles à vérifier — une erreur de mémoire de l'interviewé doit être signalée.\n"
        "4b. Vérifier la cohérence interne : si l'interviewé contredit une information donnée plus tôt "
        "dans le même texte, le signaler.\n"
        "4c. L'uniformisation est importante : vérifier la cohérence graphique des noms propres, "
        "titres d'œuvres et appellations tout au long du texte.\n"
